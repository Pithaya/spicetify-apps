...
// Created from the [countries-110m.json](https://github.com/topojson/world-atlas#world/110m.json) TopoJSON file
// With ISO 3166-1 alpha-2 country codes added
        ...
        countries: {
            ...
            geometries: [
                ...
                },
                {
                    type: 'Polygon',
                    arcs: [
                        [-8, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111],
                    ],
                    id: '180',
                    properties: {
                        name: 'Dem. Rep. Congo',
                ...
                },
                {
                    ...
                    arcs: [
                        ...
                        [
                            [
                                146, 147, 148, 149, -66, 150, 151, 152, 153,
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            -191, -98, 192, 193, 194, 195, 196, 197, 198, 199,
                            200,
                        ],
                    ],
                    id: '076',
                ...
                },
                {
                    type: 'Polygon',
                    arcs: [
                        [-360, 417, 418, 419, 420, 421, -416, -411, -406, 422],
                    ],
                    id: '364',
                    properties: {
                        name: 'Iran',
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            -446, 469, -453, 470, -238, 471, 472, 473, 474, 475,
                            476,
                        ],
                    ],
                    id: '276',
                ...
                },
                {
                    ...
                    arcs: [
                        ...
                        [
                            [
                                -61, -150, -393, -148, -391, 522, -385, -379,
                                -384, -401, -403, -399, -404, -397, -408, -410,
                                -414, -415,
                            ],
                        ],
                    ],
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            -346, -362, -356, 559, -354, 560, -352, -365, -559,
                            561,
                        ],
                    ],
                    id: '682',
                ...
                // We don't want to display Antarctica
                /*
        {
          type: "MultiPolygon",
          arcs: [
            ...
            geometries: [
                {
                    ...
                    arcs: [
                        ...
                        [
                            [
                                3, 320, 184, 255, 323, 104, 322, 311, 313, 315,
                                289, 284, 273, 290, 293, 297, 305, 307, 302,
                                304, 263, 336, 258, 272, 13, 573, 341, 338, 577,
                                575, 329, 332, 423, 487, 535, 153, 435, 164,
                                436, 461, 477, 489, 484, 490, 592, 497, 548,
                                525, 240, 507, 505, 506, 242, 501, 503, 474,
                                528, 476, 446, 142, 464, 466, 468, 158, 549,
                                430, 172, 161, 387, 391, 389, 522, 385, 371,
                                372, 543, 374, 380, 401, 394, 404, 422, 360,
                                354, 559, 352, 560, 347, 365, 349, 362, 557,
                                561, 346, 576, 124, 551, 581, 583, 115, 119,
                            ],
                            [421, 416, 64, 150, 533],
                        ],
                        [
                            [
                                17, 48, 186, 229, 227, 223, 219, 216, 213, 209,
                                230, 232, 234, 236, 200, 191, 93, 100, 203, 246,
                                207, 211, 214, 217, 220, 224, 228, 189, 50, 15,
                                58,
                            ],
                        ],
                        [[19]],
