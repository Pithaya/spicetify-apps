...
-   ~~[Made for you shortcut](./extensions/made-for-you/README.md): Add a shortcut to the "Made for you" page to the sidebar.~~ ⚠️ No longer available due to restrictions in the Spotify web API.
-   ~~[Availability map](./extensions/availability-map/README.md): See a map of every country where a track is available.~~ ⚠️ No longer available due to restrictions in the Spotify web API.
